...
<style type="text/css">
#post,#edit,#comment,#category,#users{
	width: 100px;
	height: 100px;
	margin: 30px auto;
	cursor: pointer;
...
<link rel="stylesheet" type="text/css" href="backendstyle.css" />
...
<body>
<div style="display: block;" id="page-holder">

	<div id="header">
    <div id="apDiv1">Welcome alpha, LOGOUT</div>
		<div id="header-texts">
