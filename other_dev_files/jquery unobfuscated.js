...
(function (e, t) {
  ...
  v.extend = v.fn.extend = function () {
    ...
    for (; a < f; a++) if ((e = arguments[a]) != null) for (n in e) {
      ...
      i = e[n];
      if (u === i) continue;
      l && i && (v.isPlainObject(i) || (s = v.isArray(i))) ? (s ? (s = !1, o = r && v.isArray(r) ? r : [
  ...
  v.support = function () {
    ...
    return v(function () {
      ...
      e.getComputedStyle && (t.pixelPosition = (e.getComputedStyle(r, null) || {
  ...
  v.support.checkOn || v.each(['radio',
  'checkbox'], function () {
    v.valHooks[this] = {
      get: function (e) {
  ...
  v.event = {
    ...
    trigger: function (n, r, s, o) {
      if (!s || s.nodeType !== 3 && s.nodeType !== 8) {
        ...
        if (!o && !p.noBubble && !v.isWindow(s)) {
          ...
          for (c = s; l; l = l.parentNode) m.push([l,
          g]),
          c = l;
          c === (s.ownerDocument || i) && m.push([c.defaultView || c.parentWindow || e,
          g])
        }
        for (f = 0; f < m.length && !n.isPropagationStopped(); f++) l = m[f][0],
        n.type = m[f][1],
        d = (v._data(l, 'events') || {
        }) [n.type] && v._data(l, 'handle'),
        d && d.apply(l, r),
        d = h && l[h],
    ...
    dispatch: function (n) {
      ...
      if (m && (!n.button || n.type !== 'click')) for (s = n.target; s != this; s = s.parentNode || this) if (s.disabled !== !0 || n.type !== 'click') {
        ...
        for (r = 0; r < m; r++) c = d[r],
        h = c.selector,
        u[h] === t && (u[h] = c.needsContext ? v(h, this) .index(s) >= 0 : v.find(h, this, null, [
          s
        ]) .length),
        u[h] && f.push(c);
        f.length && w.push({
      ...
      for (r = 0; r < w.length && !n.isPropagationStopped(); r++) {
        ...
        for (i = 0; i < a.matches.length && !n.isImmediatePropagationStopped(); i++) {
          ...
          n.handleObj = c,
          o = ((v.event.special[c.origType] || {
          }) .handle || c.handler) .apply(a.elem, g),
  ...
  v.extend({
    filter: function (e, t, n) {
      return n && (e = ':not(' + e + ')'),
      t.length === 1 ? v.find.matchesSelector(t[0], e) ? [
        t[0]
      ] : [
      ] : v.find.matches(e, t)
    },
  ...
  Nt.th = Nt.td,
  v.support.htmlSerialize || (Nt._default = [
    1,
    'X<div>',
    '</div>'
  ]),
  v.fn.extend({
    ...
    remove: function (e, t) {
      ...
      for (; (n = this[r]) != null; r++) if (!e || v.filter(e, [
        n
      ]) .length) !t && n.nodeType === 1 && (v.cleanData(n.getElementsByTagName('*')), v.cleanData([n])),
  ...
  v.extend({
    ...
    clean: function (e, t, n, r) {
      ...
      if (n) {
        ...
        typeof u.getElementsByTagName != 'undefined' && (g = v.grep(v.merge([], u.getElementsByTagName('script')), m), b.splice.apply(b, [
          s + 1,
          0
        ].concat(g)), s += g.length)
      }
  ...
  v(function () {
    ...
    !v.support.pixelPosition && v.fn.position && v.each(['top',
    'left'], function (e, t) {
      v.cssHooks[t] = {
        get: function (e, n) {
          if (n) {
  ...
  v.extend({
    ...
    ajax: function (e, n) {
      function T(e, n, s, a) {
        ...
        x.statusCode(g),
        g = t,
        f && p.trigger('ajax' + (l ? 'Success' : 'Error'), [
          x,
          c,
          l ? y : b
        ]),
  ...
  v.offset = {
    ...
    setOffset: function (e, t, n) {
      ...
      o = v.css(e, 'top'),
      u = v.css(e, 'left'),
      a = (r === 'absolute' || r === 'fixed') && v.inArray('auto', [
        o,
        u
      ]) > - 1,
      f = {
